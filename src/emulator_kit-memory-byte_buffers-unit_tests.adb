...
with Emulator_Kit.Memory.Byte_Buffers; pragma Elaborate (Emulator_Kit.Memory.Byte_Buffers); -- DEBUG : GNAT currently cannot figure this out on its own

package body Emulator_Kit.Memory.Byte_Buffers.Unit_Tests is
...
end Emulator_Kit.Memory.Byte_Buffers.Unit_Tests;
