...
-- This package hierarchy is used for CPU emulation
package Emulator_Kit.CPU is

   -- For now, there are neither top-level declarations nor comments in there

end Emulator_Kit.CPU;
